    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (COUNTRY_NAME) {
            ...
            case "Guernsey":
                ...
                String mapURLGG = "https://api.jawg.io/static?zoom=12&center=" + "49.448196" + "," + "-2.589490" + "&size=1500x1500&layer=jawg-terrain&format=png&access-token=DkmAEt21ZSHRGCjO1tJsAXNWQx8Njd2oHP78tIktRJvHeRx4XGQbg24l7tH8pgnD";
            ...
            case "Pitcairn":
                ...
                String mapURLPN = "https://api.jawg.io/static?zoom=15&center=-25.066668,-130.100006&size=1500x1500&layer=jawg-terrain&format=png&access-token=DkmAEt21ZSHRGCjO1tJsAXNWQx8Njd2oHP78tIktRJvHeRx4XGQbg24l7tH8pgnD";
            ...
            case "Tokelau":
                ...
                String mapURLTK = "https://api.jawg.io/static?zoom=13&center=-9.1668337,-171.8182111&size=1500x1500&layer=jawg-terrain&format=png&access-token=DkmAEt21ZSHRGCjO1tJsAXNWQx8Njd2oHP78tIktRJvHeRx4XGQbg24l7tH8pgnD";
            ...
            case "Turkmenistan":
                ...
                String mapURLTM = "https://api.jawg.io/static?zoom=6&center=" + "39" + "," + "59" + "&size=1500x1500&layer=jawg-terrain&format=png&access-token=DkmAEt21ZSHRGCjO1tJsAXNWQx8Njd2oHP78tIktRJvHeRx4XGQbg24l7tH8pgnD";
            ...
            case "Tuvalu":
                ...
                String mapURLTV = "https://api.jawg.io/static?zoom=14&center=-8.521147,179.196198&size=1500x1500&layer=jawg-terrain&format=png&access-token=DkmAEt21ZSHRGCjO1tJsAXNWQx8Njd2oHP78tIktRJvHeRx4XGQbg24l7tH8pgnD";
        ...
        String mapURL = "https://api.jawg.io/static?zoom=6&center=" + countryData.getCountryInfo().getLat() + "," + countryData.getCountryInfo().getLong() + "&size=1500x1500&layer=jawg-terrain&format=png&access-token=DkmAEt21ZSHRGCjO1tJsAXNWQx8Njd2oHP78tIktRJvHeRx4XGQbg24l7tH8pgnD";
        ...
        {
            String mapBigURL = "https://api.jawg.io/static?zoom=4&center=" + countryData.getCountryInfo().getLat() + "," + countryData.getCountryInfo().getLong() + "&size=1500x1500&layer=jawg-terrain&format=png&access-token=DkmAEt21ZSHRGCjO1tJsAXNWQx8Njd2oHP78tIktRJvHeRx4XGQbg24l7tH8pgnD";

            Picasso.get().load(mapBigURL).placeholder(R.drawable.defaultmap).into(ivMap);
        }else if (countryData.getCountry().equals("Australia")){
            String mapAusURL = "https://api.jawg.io/static?zoom=5&center=" + countryData.getCountryInfo().getLat() + "," + countryData.getCountryInfo().getLong() + "&size=1500x1500&layer=jawg-terrain&format=png&access-token=DkmAEt21ZSHRGCjO1tJsAXNWQx8Njd2oHP78tIktRJvHeRx4XGQbg24l7tH8pgnD";
