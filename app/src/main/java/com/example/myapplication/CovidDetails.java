...
public class CovidDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String mapURL = "https://api.jawg.io/static?zoom=6&center=" + coronaData.getCountryInfo().getLat() + "," + coronaData.getCountryInfo().getLong() + "&size=1500x1500&layer=jawg-terrain&format=png&access-token=DkmAEt21ZSHRGCjO1tJsAXNWQx8Njd2oHP78tIktRJvHeRx4XGQbg24l7tH8pgnD";
        ...
        {
            String mapBigURL = "https://api.jawg.io/static?zoom=4&center=" + coronaData.getCountryInfo().getLat() + "," + coronaData.getCountryInfo().getLong() + "&size=1500x1500&layer=jawg-terrain&format=png&access-token=DkmAEt21ZSHRGCjO1tJsAXNWQx8Njd2oHP78tIktRJvHeRx4XGQbg24l7tH8pgnD";

            Picasso.get().load(mapBigURL).placeholder(R.drawable.defaultmap).into(ivMap);
        }else if (coronaData.getCountry().equals("Australia")){
            String mapAusURL = "https://api.jawg.io/static?zoom=5&center=" + coronaData.getCountryInfo().getLat() + "," + coronaData.getCountryInfo().getLong() + "&size=1500x1500&layer=jawg-terrain&format=png&access-token=DkmAEt21ZSHRGCjO1tJsAXNWQx8Njd2oHP78tIktRJvHeRx4XGQbg24l7tH8pgnD";
